...
> The VS Code extension (Beta) lets you see Qwen's changes in real-time through a native graphical interface integrated directly into your IDE, making it easier to access and interact with LAL.
...
- **Native IDE experience**: Dedicated LAL sidebar panel accessed via the Qwen icon
...
- **Multiple sessions**: Run multiple LAL sessions simultaneously
