...
This document details all commands supported by LAL, helping you efficiently manage sessions, customize the interface, and control its behavior.

LAL commands are triggered through specific prefixes and fall into three categories:

| Prefix Type                | Function Description                                | Typical Use Case                                                 |
| -------------------------- | --------------------------------------------------- | ---------------------------------------------------------------- |
| Slash Commands (`/`)       | Meta-level control of LAL itself                    | Managing sessions, modifying settings, getting help              |
...
Slash commands are used to manage LAL sessions, interface, and basic behavior.
...
| `/hooks`          | Manage LAL hooks                                                                      | `/hooks`, `/hooks list`                                                                                   |
...
> [!warning]
>
> Only install extensions (`/extensions install`) from sources you trust. Extensions can bundle MCP servers, skills, and commands that run with the same permissions as LAL itself — they can access your files, API keys, and conversation data. `/extensions install` does not prompt for confirmation.
...
| `/qc-helper` | Answer questions about LAL usage and configuration          | `/qc-helper how do I configure MCP?`                                      |
...
| `/docs`          | Open full LAL documentation in browser                                                                                         | `/docs`                                                                             |
...
| `/bug`           | Submit issue about LAL                                                                                                         | `/bug Button click unresponsive`                                                    |
...
Use `/auth` inside a LAL session to configure authentication. Use `/doctor` to inspect the current authentication and environment status.
...
Exclamation commands allow you to execute system commands directly within LAL.
...
Lists your recent LAL sessions with metadata.
