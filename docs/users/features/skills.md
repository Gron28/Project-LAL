...
> Create, manage, and share Skills to extend LAL's capabilities.

This guide shows you how to create, use, and manage Agent Skills in **LAL**. Skills are modular capabilities that extend the model's effectiveness through organized folders containing instructions (and optionally scripts/resources).

## Prerequisites

- LAL (recent version)
- Basic familiarity with LAL ([Quickstart](../quickstart.md))
...
## Instructions
Provide clear, step-by-step guidance for LAL.
...
To view available Skills, ask LAL directly:
...
If LAL doesn't use your Skill, check these common issues:
...
Run LAL with debug mode to see Skill loading errors:
...
Changes take effect the next time you start LAL. If LAL is already running, restart it to load the updates.
