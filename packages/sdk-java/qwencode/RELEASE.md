...
This release includes updates to the LAL Java SDK with improved session management, enhanced transport options, and better error handling capabilities.
...
3. **Extended API Coverage**: More comprehensive coverage of LAL CLI features
