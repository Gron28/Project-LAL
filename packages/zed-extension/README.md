# LAL Agent Server Extension for Zed

A [Zed](https://zed.dev) extension that integrates [LAL](https://github.com/QwenLM/qwen-code) as an AI agent server using the [Agent Client Protocol (ACP)](https://agentclientprotocol.com).
...
3. Search for "LAL"
4. Click "Install"
5. Switch to the **Agent Server** tab and ensure LAL is enabled
...
2. Select "LAL" from the agent list
...
- Node.js >= 22 (for running LAL agent server)

## Configuration

### Environment Variables

When running as an agent server, LAL will:
...
- [LAL Issues](https://github.com/QwenLM/qwen-code/issues)
- [LAL Zed Extension Issues](https://github.com/QwenLM/qwen-code-zed-extension/issues)

## Documentation

- [LAL Documentation](https://qwenlm.github.io/qwen-code-docs/)
...
- [LAL Discussions](https://github.com/QwenLM/qwen-code/discussions)
...
LAL is an AI-powered coding assistant that helps developers write better code faster. It provides intelligent code completion, refactoring suggestions, bug detection, and natural language code generation.
