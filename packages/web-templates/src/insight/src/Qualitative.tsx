  ...
  return (
    <div className="qwen-md-section">
      ...
      <p className="text-xs text-slate-500 mb-3">
        Just copy this into LAL to add it to your QWEN.md.
      </p>
    ...
    <>
      {hasFeatureSuggestions && (
        <>
          ...
          <p className="text-xs text-slate-500 mb-3">
            Just copy this into LAL and it&apos;ll set it up for you.
          </p>
      ...
      {hasUsagePatterns && (
        <>
          ...
          <p className="text-xs text-slate-500 mb-3">
            Just copy this into LAL and it&apos;ll walk you through it.
          </p>
              ...
              improvements.usage_patterns.map((pat, idx) => (
                <div key={idx} className="pattern-card">
                  ...
                  <div className="copyable-prompt-section">
                    <div className="prompt-label">Paste into LAL:</div>
