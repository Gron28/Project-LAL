...
// German translations for LAL CLI
// Deutsche Übersetzungen für LAL CLI
...
export default {
  ...
  'for help on LAL': 'für Hilfe zu LAL',
  ...
  'List available LAL tools. Usage: /tools [desc]':
    'Verfügbare LAL Werkzeuge auflisten. Verwendung: /tools [desc]',
  ...
  'Available LAL CLI tools:': 'Verfügbare LAL CLI-Werkzeuge:',
  ...
  'open full LAL documentation in your browser':
    'Vollständige LAL Dokumentation im Browser öffnen',
  ...
  'You are installing an extension from {{originSource}}. Some features may not work perfectly with LAL.':
    'Sie installieren eine Erweiterung von {{originSource}}. Einige Funktionen funktionieren möglicherweise nicht perfekt mit LAL.',
  ...
  'IDE integration is not supported in your current environment. To use this feature, run LAL in one of these supported IDEs: VS Code or VS Code forks.':
    'IDE-Integration wird in Ihrer aktuellen Umgebung nicht unterstützt. Um diese Funktion zu nutzen, führen Sie LAL in einer dieser unterstützten IDEs aus: VS Code oder VS Code-Forks.',
  ...
  // Commands - Hooks
  // ============================================================================
  'Manage LAL hooks': 'LAL-Hooks verwalten',
  ...
  'This menu is read-only. To add or modify hooks, edit settings.json directly or ask LAL.':
    'Dieses Menü ist schreibgeschützt. Um Hooks hinzuzufügen oder zu ändern, bearbeiten Sie settings.json direkt oder fragen Sie LAL.',
  ...
  'To re-enable hooks, remove "disableAllHooks" from settings.json or ask LAL.':
    'Um Hooks wieder zu aktivieren, entfernen Sie "disableAllHooks" aus settings.json oder fragen Sie LAL.',
  // Hooks - Source
  Project: 'Projekt',
  User: 'Benutzer',
  Skill: 'Skill',
  ...
  'Right before LAL concludes its response':
    'Direkt bevor LAL seine Antwort abschließt',
  ...
  "LAL won't ask before using allowed tools.":
    'LAL fragt nicht, bevor erlaubte Tools verwendet werden.',
  'LAL will ask before using these tools.':
    'LAL fragt, bevor diese Tools verwendet werden.',
  'LAL is not allowed to use denied tools.':
    'LAL darf verweigerte Tools nicht verwenden.',
  ...
  'LAL can read files in the workspace, and make edits when auto-accept edits is on.':
    'LAL kann Dateien im Arbeitsbereich lesen und Bearbeitungen vornehmen, wenn die automatische Akzeptierung aktiviert ist.',
  'LAL will be able to read files in this directory and make edits when auto-accept edits is on.':
    'LAL kann Dateien in diesem Verzeichnis lesen und Bearbeitungen vornehmen, wenn die automatische Akzeptierung aktiviert ist.',
  ...
  'You can run any shell commands from LAL using ! (e.g. !ls).':
    'Sie können beliebige Shell-Befehle in LAL mit ! ausführen (z. B. !ls).',
  ...
  'Add a QWEN.md file to give LAL persistent project context.':
    'Fügen Sie eine QWEN.md-Datei hinzu, um LAL dauerhaften Projektkontext zu geben.',
  ...
  "Set up LAL's status line UI": 'LALs Statusleisten-UI einrichten',
  ...
  'Check for LAL updates and install if available':
    'Auf LAL-Updates prüfen und installieren, falls verfügbar',
  'LAL update available! {{current}} → {{latest}}':
    'LAL-Update verfügbar! {{current}} → {{latest}}',
  'A new version of LAL is available! {{current}} → {{latest}}':
    'Eine neue Version von LAL ist verfügbar! {{current}} → {{latest}}',
  'LAL {{version}} is up to date!': 'LAL {{version}} ist aktuell!',
  ...
  'Update successful! Please restart LAL to use the new version. Switching model providers before restarting may not work correctly.':
    'Update erfolgreich! Bitte starten Sie LAL neu, um die neue Version zu verwenden. Das Wechseln von Modellanbietern vor dem Neustart funktioniert möglicherweise nicht korrekt.',
  ...
  'Manual update required. Please reinstall LAL.':
    'Manuelles Update erforderlich. Bitte installieren Sie LAL neu.',
