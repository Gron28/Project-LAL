...
// Traductions françaises pour LAL CLI
...
export default {
  ...
  'for help on LAL': "pour l'aide de LAL",
  ...
  'List available LAL tools. Usage: /tools [desc]':
    'Lister les outils LAL disponibles. Utilisation : /tools [desc]',
  ...
  Bundled: 'Intégrée',
  'Available LAL CLI tools:': 'Outils LAL CLI disponibles :',
  ...
  'open full LAL documentation in your browser':
    'ouvrir la documentation complète de LAL dans votre navigateur',
  ...
  'You are installing an extension from {{originSource}}. Some features may not work perfectly with LAL.':
    'Vous installez une extension depuis {{originSource}}. Certaines fonctionnalités peuvent ne pas fonctionner parfaitement avec LAL.',
  ...
  'IDE integration is not supported in your current environment. To use this feature, run LAL in one of these supported IDEs: VS Code or VS Code forks.':
    "L'intégration IDE n'est pas prise en charge dans votre environnement actuel. Pour utiliser cette fonctionnalité, exécutez LAL dans l'un des IDEs pris en charge : VS Code ou ses dérivés.",
  ...
  // Commandes - Hooks
  // ============================================================================
  'Manage LAL hooks': 'Gérer les hooks LAL',
  ...
  'This menu is read-only. To add or modify hooks, edit settings.json directly or ask LAL.':
    'Ce menu est en lecture seule. Pour ajouter ou modifier des hooks, éditez settings.json directement ou demandez à LAL.',
  ...
  'To re-enable hooks, remove "disableAllHooks" from settings.json or ask LAL.':
    'Pour réactiver les hooks, supprimez "disableAllHooks" de settings.json ou demandez à LAL.',
  Project: 'Projet',
  User: 'Utilisateur',
  Skill: 'Compétence',
  System: 'Système',
  ...
  'Right before LAL concludes its response':
    'Juste avant que LAL conclue sa réponse',
  ...
  "LAL won't ask before using allowed tools.":
    "LAL ne demandera pas avant d'utiliser les outils autorisés.",
  'LAL will ask before using these tools.':
    "LAL demandera avant d'utiliser ces outils.",
  'LAL is not allowed to use denied tools.':
    "LAL n'est pas autorisé à utiliser les outils refusés.",
  ...
  'LAL can read files in the workspace, and make edits when auto-accept edits is on.':
    "LAL peut lire les fichiers dans l'espace de travail et effectuer des modifications lorsque l'acceptation automatique est activée.",
  'LAL will be able to read files in this directory and make edits when auto-accept edits is on.':
    "LAL pourra lire les fichiers dans ce répertoire et effectuer des modifications lorsque l'acceptation automatique est activée.",
  ...
  'You can run any shell commands from LAL using ! (e.g. !ls).':
    "Vous pouvez exécuter n'importe quelle commande shell depuis LAL en utilisant ! (ex. !ls).",
  ...
  "Set up LAL's status line UI":
    "Configurer l'interface de la barre de statut de LAL",
  'Press ↑ to edit queued messages':
    'Appuyez sur ↑ pour modifier les messages en file d’attente',
  'Add a QWEN.md file to give LAL persistent project context.':
    'Ajoutez un fichier QWEN.md pour donner à LAL un contexte de projet persistant.',
  ...
  'In/Out': 'Ent/Sort',
  // Update command
  'Check for LAL updates and install if available':
    'Vérifier les mises à jour de LAL et installer si disponible',
  'LAL update available! {{current}} → {{latest}}':
    'Mise à jour de LAL disponible ! {{current}} → {{latest}}',
  'A new version of LAL is available! {{current}} → {{latest}}':
    'Une nouvelle version de LAL est disponible ! {{current}} → {{latest}}',
  'LAL {{version}} is up to date!': 'LAL {{version}} est à jour !',
  ...
  'Update successful! Please restart LAL to use the new version. Switching model providers before restarting may not work correctly.':
    'Mise à jour réussie ! Redémarrez LAL pour utiliser la nouvelle version. Changer de fournisseur de modèle avant le redémarrage peut ne pas fonctionner correctement.',
  ...
  'Manual update required. Please reinstall LAL.':
    'Mise à jour manuelle requise. Veuillez réinstaller LAL.',
