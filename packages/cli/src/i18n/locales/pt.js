...
// Portuguese translations for LAL CLI (pt-BR)
...
export default {
  ...
  'for help on LAL': 'para ajuda sobre o LAL',
  ...
  'List available LAL tools. Usage: /tools [desc]':
    'Listar ferramentas LAL disponíveis. Uso: /tools [desc]',
  ...
  Bundled: 'Integrada',
  'Available LAL CLI tools:': 'Ferramentas CLI do LAL disponíveis:',
  ...
  'open full LAL documentation in your browser':
    'abrir documentação completa do LAL no seu navegador',
  ...
  'Generate with LAL (Recommended)': 'Gerar com LAL (Recomendado)',
  ...
  // ============================================================================
  'View and edit LAL settings': 'Ver e editar configurações do LAL',
  Settings: 'Configurações',
  'To see changes, LAL must be restarted. Press r to exit and apply changes now.':
    'Para ver as alterações, o LAL deve ser reiniciado. Pressione r para sair e aplicar as alterações agora.',
  // ============================================================================
  // Settings Labels
  // ============================================================================
  'Vim Mode': 'Modo Vim',
  ...
  'You are installing an extension from {{originSource}}. Some features may not work perfectly with LAL.':
    'Você está instalando uma extensão de {{originSource}}. Alguns recursos podem não funcionar perfeitamente com o LAL.',
  ...
  'IDE integration is not supported in your current environment. To use this feature, run LAL in one of these supported IDEs: VS Code or VS Code forks.':
    'A integração com IDE não é suportada no seu ambiente atual. Para usar este recurso, execute o LAL em um destes IDEs suportados: VS Code ou forks do VS Code.',
  ...
  // Commands - Hooks
  // ============================================================================
  'Manage LAL hooks': 'Gerenciar hooks do LAL',
  ...
  'This menu is read-only. To add or modify hooks, edit settings.json directly or ask LAL.':
    'Este menu é somente leitura. Para adicionar ou modificar hooks, edite settings.json diretamente ou pergunte ao LAL.',
  ...
  'To re-enable hooks, remove "disableAllHooks" from settings.json or ask LAL.':
    'Para reativar os hooks, remova "disableAllHooks" do settings.json ou pergunte ao LAL.',
  // Hooks - Source
  Project: 'Projeto',
  User: 'Usuário',
  Skill: 'Habilidade',
  ...
  'Right before LAL concludes its response':
    'Logo antes do LAL concluir sua resposta',
  ...
  "LAL won't ask before using allowed tools.":
    'O LAL não perguntará antes de usar ferramentas permitidas.',
  'LAL will ask before using these tools.':
    'O LAL perguntará antes de usar essas ferramentas.',
  'LAL is not allowed to use denied tools.':
    'O LAL não tem permissão para usar ferramentas negadas.',
  ...
  'LAL can read files in the workspace, and make edits when auto-accept edits is on.':
    'O LAL pode ler arquivos na área de trabalho e fazer edições quando a aceitação automática está ativada.',
  'LAL will be able to read files in this directory and make edits when auto-accept edits is on.':
    'O LAL poderá ler arquivos neste diretório e fazer edições quando a aceitação automática está ativada.',
  ...
  'You can run any shell commands from LAL using ! (e.g. !ls).':
    'Você pode executar quaisquer comandos shell do LAL usando ! (ex: !ls).',
  ...
  'Add a QWEN.md file to give LAL persistent project context.':
    'Adicione um arquivo QWEN.md para dar ao LAL um contexto persistente do projeto.',
  ...
  "Set up LAL's status line UI":
    'Configurar a interface da barra de status do LAL',
  ...
  'Check for LAL updates and install if available':
    'Verificar atualizações do LAL e instalar se disponível',
  ...
  'Update successful! Please restart LAL to use the new version. Switching model providers before restarting may not work correctly.':
    'Atualização bem-sucedida! Reinicie o LAL para usar a nova versão. Alternar provedores de modelo antes de reiniciar pode não funcionar corretamente.',
  ...
  'Manual update required. Please reinstall LAL.':
    'Atualização manual necessária. Reinstale o LAL.',
