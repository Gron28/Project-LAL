...
// Traduccions en català per al CLI de LAL per Jordi Mas i Hernàndez <jmas@softcatala.org>
...
export default {
  ...
  'for help on LAL': 'per a ajuda sobre LAL',
  ...
  'List available LAL tools. Usage: /tools [desc]':
    'Llistar les eines disponibles de LAL. Ús: /tools [desc]',
  ...
  Bundled: 'Integrada',
  'Available LAL CLI tools:': 'Eines del CLI de LAL disponibles:',
  ...
  'open full LAL documentation in your browser':
    'obrir la documentació completa de LAL al navegador',
  ...
  'Generate with LAL (Recommended)': 'Generar amb LAL (Recomanat)',
  ...
  'You are installing an extension from {{originSource}}. Some features may not work perfectly with LAL.':
    'Esteu instal·lant una extensió des de {{originSource}}. Algunes funcions poden no funcionar perfectament amb LAL.',
  ...
  'IDE integration is not supported in your current environment. To use this feature, run LAL in one of these supported IDEs: VS Code or VS Code forks.':
    "La integració de l'IDE no és compatible en el vostre entorn actual. Per usar aquesta funció, executeu LAL en un dels IDEs compatibles: VS Code o bifurcacions de VS Code.",
  ...
  // Ordres - Hooks
  // ============================================================================
  'Manage LAL hooks': 'Gestionar els hooks de LAL',
  ...
  'This menu is read-only. To add or modify hooks, edit settings.json directly or ask LAL.':
    'Aquest menú és de només lectura. Per afegir o modificar hooks, editeu settings.json directament o demaneu-ho a LAL.',
  ...
  'To re-enable hooks, remove "disableAllHooks" from settings.json or ask LAL.':
    'Per tornar a activar els hooks, elimineu "disableAllHooks" de settings.json o demaneu-ho a LAL.',
  Project: 'Projecte',
  User: 'Usuari',
  Skill: 'Habilitat',
  System: 'Sistema',
  ...
  'Right before LAL concludes its response':
    'Immediatament abans que LAL conclou la seva resposta',
  ...
  "LAL won't ask before using allowed tools.":
    "LAL no preguntarà abans d'usar les eines permeses.",
  'LAL will ask before using these tools.':
    "LAL preguntarà abans d'usar aquestes eines.",
  'LAL is not allowed to use denied tools.':
    'LAL no té permís per usar les eines denegades.',
  ...
  'LAL can read files in the workspace, and make edits when auto-accept edits is on.':
    "LAL pot llegir fitxers a l'espai de treball i fer canvis quan l'acceptació automàtica de canvis està activada.",
  'LAL will be able to read files in this directory and make edits when auto-accept edits is on.':
    "LAL podrà llegir fitxers en aquest directori i fer canvis quan l'acceptació automàtica de canvis està activada.",
  ...
  'You can run any shell commands from LAL using ! (e.g. !ls).':
    'Podeu executar qualsevol ordre shell des de LAL usant ! (p. ex. !ls).',
  ...
  'Add a QWEN.md file to give LAL persistent project context.':
    'Afegiu un fitxer QWEN.md per donar a LAL un context persistent del projecte.',
  ...
  "Set up LAL's status line UI":
    "Configurar la interfície de la barra d'estat de LAL",
  ...
  'Check for LAL updates and install if available':
    'Comprova les actualitzacions de LAL i instal·la si estan disponibles',
  ...
  'Update successful! Please restart LAL to use the new version. Switching model providers before restarting may not work correctly.':
    'Actualització correcta! Reinicieu LAL per utilitzar la nova versió. Canviar de proveïdor de models abans de reiniciar pot no funcionar correctament.',
  ...
  'Manual update required. Please reinstall LAL.':
    'Actualització manual requerida. Reinstal·leu LAL.',
