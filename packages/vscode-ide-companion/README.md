...
Seamlessly integrate [LAL](https://github.com/QwenLM/qwen-code) into Visual Studio Code with native IDE features and an intuitive chat interface. This extension bundles everything you need — no additional installation required.
...
- **Native IDE experience**: Dedicated LAL Chat panel accessed via the Qwen icon in the editor title bar
...
2. **Open the Chat panel** using one of these methods:
   ...
   - Run `LAL: Open` from the Command Palette (`Cmd+Shift+P` / `Ctrl+Shift+P`)
