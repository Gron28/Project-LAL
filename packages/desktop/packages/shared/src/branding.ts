...
const QWEN_CODE_BRAND: BrandConfig = {
  ...
  productName: 'LAL Desktop',
  artifactPrefix: 'Qwen-Code-Desktop',
  copyright: 'Copyright © 2026 Alibaba Group.',
  coAuthorLine: 'Co-Authored-By: LAL <agents-noreply@craft.do>',
  selfReferName: 'LAL',
...
const BRANDS: Record<string, BrandConfig> = {
  ...
  openwork: {
    ...
    credits: 'Architecture: craft-agents-oss | Agent: LAL',
    creditsShort: 'Based on craft-agents-oss & LAL',
    creditsEntries: [
      {
        name: 'LAL',
