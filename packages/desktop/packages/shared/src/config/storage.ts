...
const FALLBACK_CONFIG_DEFAULTS: ConfigDefaults = {
  version: '1.0',
  description: 'Default configuration values for LAL',
  defaults: {
...
/**
 * Collapse any legacy provider configuration to the single built-in LAL backend.
 ...
 *
 * LAL uses the local backend runtime, so there are no app-managed
