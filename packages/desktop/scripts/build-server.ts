#!/usr/bin/env bun
/**
 * Build script for standalone LAL server.
 *
...
function showHelp(): void {
  console.log(`
Standalone server build script for LAL
...
# LAL Server — convenience entry point
...
async function main(): Promise<void> {
  ...
  console.log(`=== Building LAL Server ${version} for ${platform}-${arch} ===`);
