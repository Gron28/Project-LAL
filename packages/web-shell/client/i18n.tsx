...
const EN: Messages = {
  ...
  'local.docs': 'Open the full LAL documentation',
  ...
  'skilldesc.stuck': 'Diagnose frozen or slow LAL sessions',
  ...
  'skilldesc.desktopPet': 'Create a pixel-art desktop pet for LAL',
  ...
  'skilldesc.e2eTesting': 'Run end-to-end tests of the LAL CLI',
  ...
  'skilldesc.qwenCodeClaw': 'Use LAL as a code-understanding agent',
  ...
  'skilldesc.triage': 'Triage and review LAL issues and PRs',
...
const ZH: Messages = {
  ...
  'agent.create.method.qwen': '使用 LAL 生成',
  'agent.create.method.qwen.recommended': '使用 LAL 生成（推荐）',
  ...
  'skilldesc.qwenCodeClaw': '将 LAL 用作代码理解智能体',
  ...
  'skilldesc.triage': '把关和审查 LAL 的 issue 与 PR',
  ...
  'settings.description.general.gitCoAuthor.commit':
    '通过 LAL 创建 commit 时，添加 Co-authored-by trailer，并写入逐文件 AI 归因 git note。关闭后两者都会跳过。',
  'settings.label.general.gitCoAuthor.pr': '归因：PR',
  'settings.description.general.gitCoAuthor.pr':
    '运行 gh pr create 时，在 PR 描述中追加 LAL 归因行。',
  ...
  'settings.description.general.preventSystemSleep':
    '当 LAL 正在流式生成模型回复或执行工具时防止系统睡眠。空闲输入状态和权限确认状态不会阻止睡眠。',
