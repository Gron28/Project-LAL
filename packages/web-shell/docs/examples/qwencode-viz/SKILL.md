...
name: qwencode-viz
description: >
  Generate renderable chart outputs for clients that support the LAL Web
...
# LAL Visualization Skill

Use this skill to emit chart blocks that a LAL Web Shell host can render.
...
- The active host is LAL Web Shell, or an equivalent Web Shell client.
