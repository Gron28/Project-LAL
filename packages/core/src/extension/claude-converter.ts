...
/**
 * Converter for Claude Code plugins to LAL format.
 */
...
/**
 * Converts a Claude agent config to LAL subagent format.
 * @param claudeAgent Claude agent configuration
 * @returns Converted agent config compatible with LAL SubagentConfig
 */
...
/**
 * Converts a Claude plugin config to LAL format.
...
/**
 * Converts a complete Claude plugin package to LAL format.
...
/**
 * Converts a standalone Claude plugin to LAL format. A standalone plugin
