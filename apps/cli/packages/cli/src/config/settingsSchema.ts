...
const SETTINGS_SCHEMA = {
  ...
  general: {
    ...
    properties: {
      ...
      gitCoAuthor: {
        ...
        description:
          'Attribution added to git commits and pull requests created through LAL.',
        showInDialog: false,
        ...
        properties: {
          commit: {
            ...
            default: true,
            description:
              'Add a Co-authored-by trailer to git commit messages AND attach a per-file AI-attribution git note (`refs/notes/ai-attribution`) for commits made through LAL. Disabling skips both.',
            showInDialog: true,
          },
          pr: {
            type: 'boolean',
            ...
            default: true,
            description:
              'Append a LAL attribution line to PR descriptions when running `gh pr create`.',
            showInDialog: true,
          },
        },
      },
      ...
      preventSystemSleep: {
        ...
        default: true,
        description:
          'Prevent the system from sleeping while LAL is streaming a model response or executing tools. Idle prompt time and permission prompts do not inhibit sleep.',
        showInDialog: true,
      },
      chatRecording: {
        type: 'boolean',
  ...
  ui: {
    ...
    properties: {
      ...
      showStatusInTitle: {
        ...
        default: true,
        description:
          'Show LAL session name and status in the terminal window title',
        showInDialog: true,
      },
      hideTips: {
        type: 'boolean',
      ...
      customBannerTitle: {
        ...
        default: '' as string,
        description:
          'Replace the default ">_ LAL" title shown in the banner info panel. The version suffix is always appended.',
        showInDialog: false,
      },
  ...
  model: {
    ...
    properties: {
      ...
      skipLoopDetection: {
        ...
        default: false,
        description:
          'Skip headless loop heuristics (content/thought repetition, read/action/shell stagnation, global duplicates, and alternating calls). Interactive sessions always skip these broad heuristics. Headless runs default to false. Exact consecutive calls and the per-turn cap remain active in every mode.',
        showInDialog: false,
      },
      maxToolCallsPerTurn: {
        type: 'number',
      ...
      generationConfig: {
        ...
        properties: {
          ...
          contextWindowSize: {
            ...
            default: undefined,
            description:
              "Overrides the default context window size for the selected model. Use this setting when a provider's effective context limit differs from LAL's default. This value defines the model's assumed maximum context capacity, not a per-request token limit.",
            parentKey: 'generationConfig',
            showInDialog: false,
          },
        },
  ...
  stopHookBlockingCap: {
    ...
    description:
      'Maximum consecutive blocking Stop/SubagentStop hook decisions before LAL overrides the hook loop and ends the turn. Can be overridden by QWEN_CODE_STOP_HOOK_BLOCK_CAP.',
