...
export default {
  ...
  'for help on LAL': 'Справка по LAL',
  ...
  'List available LAL tools. Usage: /tools [desc]':
    'Просмотр доступных инструментов LAL. Использование: /tools [desc]',
  ...
  Bundled: 'Встроенный',
  'Available LAL CLI tools:': 'Доступные инструменты LAL CLI:',
  ...
  'open full LAL documentation in your browser':
    'Открытие полной документации LAL в браузере',
  ...
  'Generate with LAL (Recommended)':
    'Сгенерировать с помощью LAL (Рекомендуется)',
  ...
  // ============================================================================
  'View and edit LAL settings': 'Просмотр и изменение настроек LAL',
  Settings: 'Настройки',
  'To see changes, LAL must be restarted. Press r to exit and apply changes now.':
    'Для применения изменений необходимо перезапустить LAL. Нажмите r для выхода и применения изменений.',
  // ============================================================================
  // Метки настроек
  // ============================================================================
  'Vim Mode': 'Режим Vim',
  ...
  'You are installing an extension from {{originSource}}. Some features may not work perfectly with LAL.':
    'Вы устанавливаете расширение от {{originSource}}. Некоторые функции могут работать не идеально с LAL.',
  ...
  'IDE integration is not supported in your current environment. To use this feature, run LAL in one of these supported IDEs: VS Code or VS Code forks.':
    'Интеграция с IDE не поддерживается в вашем окружении. Для использования этой функции запустите LAL в одной из поддерживаемых IDE: VS Code или форках VS Code.',
  ...
  // Commands - Hooks
  // ============================================================================
  'Manage LAL hooks': 'Управлять хуками LAL',
  ...
  'This menu is read-only. To add or modify hooks, edit settings.json directly or ask LAL.':
    'Это меню только для чтения. Чтобы добавить или изменить хуки, отредактируйте settings.json напрямую или спросите LAL.',
  ...
  'To re-enable hooks, remove "disableAllHooks" from settings.json or ask LAL.':
    'Чтобы снова включить хуки, удалите "disableAllHooks" из settings.json или спросите LAL.',
  // Hooks - Source
  Project: 'Проект',
  User: 'Пользователь',
  Skill: 'Навык',
  ...
  'Right before LAL concludes its response':
    'Непосредственно перед завершением ответа LAL',
  ...
  "LAL won't ask before using allowed tools.":
    'LAL не будет спрашивать перед использованием разрешённых инструментов.',
  'LAL will ask before using these tools.':
    'LAL спросит перед использованием этих инструментов.',
  'LAL is not allowed to use denied tools.':
    'LAL не может использовать запрещённые инструменты.',
  ...
  'LAL can read files in the workspace, and make edits when auto-accept edits is on.':
    'LAL может читать файлы в рабочей области и вносить правки, когда автоприём правок включён.',
  'LAL will be able to read files in this directory and make edits when auto-accept edits is on.':
    'LAL сможет читать файлы в этом каталоге и вносить правки, когда автоприём правок включён.',
  ...
  'You can run any shell commands from LAL using ! (e.g. !ls).':
    'Вы можете выполнять любые shell-команды в LAL с помощью ! (например, !ls).',
  ...
  'Add a QWEN.md file to give LAL persistent project context.':
    'Добавьте файл QWEN.md, чтобы предоставить LAL постоянный контекст проекта.',
  ...
  "Set up LAL's status line UI": 'Настроить интерфейс строки состояния LAL',
  ...
  'Check for LAL updates and install if available':
    'Проверить обновления LAL и установить при наличии',
  'LAL update available! {{current}} → {{latest}}':
    'Доступно обновление LAL! {{current}} → {{latest}}',
  'A new version of LAL is available! {{current}} → {{latest}}':
    'Доступна новая версия LAL! {{current}} → {{latest}}',
  'LAL {{version}} is up to date!': 'LAL {{version}} актуален!',
  ...
  'Update successful! Please restart LAL to use the new version. Switching model providers before restarting may not work correctly.':
    'Обновление успешно! Перезапустите LAL, чтобы использовать новую версию. Переключение поставщиков моделей до перезапуска может работать некорректно.',
  ...
  'Manual update required. Please reinstall LAL.':
    'Требуется ручное обновление. Переустановите LAL.',
