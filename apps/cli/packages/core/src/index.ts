...
export * from './core/code-mode-presets.js';
...
// ============================================================================
// LAL gateway wire protocol — mirrored from web/src/lib/protocol/index.ts by
// scripts/check_protocol_drift.mjs (see packages/core/src/lal/protocol.ts for
// the compatibility rule). Re-exported here, not hand-edited, so the CLI's
// run-stream attach engine (packages/cli/src/lal/attach/) can import it via
// the normal package barrel instead of reaching across package boundaries.
// ============================================================================
export * from './lal/protocol.js';
