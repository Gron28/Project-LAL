...
/**
 * Converter for Gemini extensions to LAL format.
 */
...
/**
 * Converts a Gemini extension config to LAL format.
...
/**
 * Converts a complete Gemini extension package to LAL format.
