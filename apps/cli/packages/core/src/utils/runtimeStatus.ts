 ...
 *
 * Runtime status sidecar for an active interactive LAL session.
 *
 ...
 *
 *     "Which LAL session is the running PID X serving?"
 *
...
/** Snapshot of a live LAL session process for external observers. */
 ...
 * dataclass.
 *
 * Note: a returned record only proves that *some* LAL process
